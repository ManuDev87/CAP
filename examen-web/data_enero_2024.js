const examData_enero_2024 = [
  {
    "num": "1",
    "question": "¿Cómo se denomina la fuerza que opone resistencia al movimiento por contacto entre los neumáticos de un camión y la calzada?",
    "options": [
      {
        "id": "a",
        "text": "Rozamiento."
  ...
  {
    "num": "2",
    "question": "¿Cómo se llama el vehículo concebido especialmente para el transporte de materias sólidas, pulverulentas o granulosas en depósito cerrado?",
    "options": [
      {
        "id": "a",
        "text": "Vehículo silo."
      ...
      {
        "id": "d",
        "text": "Todas las respuestas anteriores son incorrectas. Referencia Legal: 2822/1998, RD, Anexo II, C"
      }
    ],
    "correct": "a"
  },
  {
    "num": "3",
    "question": "El transporte de mercancías con temperatura regulada y destinadas al consumo humano:",
    "options": [
      {
        "id": "a",
        "text": "no está regulado específicamente."
      },
      {
        "id": "b",
        "text": "tiene una normativa especial, pero solo para alimentos congelados."
      },
      {
        "id": "c",
        "text": "tiene una regulación especial."
      },
      {
        "id": "d",
        "text": "está regulado solo si se trata de transporte combinado. Referencia Legal: 1202/2005, RD, Art. 1"
      }
    ],
    "correct": "c"
  },
  {
    "num": "4",
    "question": "Se denomina aceleración a la magnitud física que mide la variación:",
    "options": [
      {
        "id": "a",
        "text": "de la velocidad de un camión respecto de la distancia recorrida."
      },
      {
        "id": "b",
        "text": "de la velocidad de un camión respecto del tiempo."
      },
      {
        "id": "c",
        "text": "del tiempo en relación con la distancia recorrida por un camión."
      },
      {
        "id": "d",
        "text": "de la distancia recorrida respecto de la velocidad de un camión."
      }
    ],
    "correct": "b"
  },
  {
    ...
    "options": [
      ...
      {
        "id": "c",
        "text": "Refrigerado normal de la clase A."
      },
      {
        "id": "d",
        "text": "Refrigerado reforzado de la clase A."
      }
    ],
    "correct": "a"
  },
  ...
  {
    "num": "8",
    "question": "¿Tiene la consideración de transporte internacional un transporte de mercancías entre Gerona y San Sebastián a través de Francia?",
    "options": [
      {
        "id": "a",
        "text": "No, porque el origen y el destino se encuentran dentro del mismo país."
      },
      {
        "id": "b",
        "text": "No, porque la normativa aplicable, en caso de incidencia en el transporte, sería siempre la misma."
      },
      {
        "id": "c",
        "text": "Sí, porque transcurre parcialmente por un Estado extranjero."
      },
      {
        "id": "d",
        "text": "Sí, porque un transporte entre diferentes Comunidades Autónomas tiene la consideración de  transporte internacional."
      }
    ],
    "correct": "c"
  },
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Archivar la documentación de la empresa."
      },
      {
        "id": "b",
      ...
      {
        "id": "c",
        "text": "Supervisar la colocación de la carga."
      },
      {
        "id": "d",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "a",
        "text": "Buscar operaciones de transporte."
      },
      {
        "id": "b",
        "text": "Vigilar el cumplimiento de las normas relacionadas con el transporte."
      },
      {
        "id": "c",
  ...
  {
    "num": "14",
    "question": "¿Qué es el cuaderno TIR?",
    "options": [
      {
        "id": "a",
        "text": "Es el documento que acompaña a las mercancías en los transportes efectuados en régimen TIR."
      },
      {
        "id": "b",
        "text": "El conjunto de normas del régimen TIR."
      },
      {
        "id": "c",
        "text": "El documento que autoriza a los vehículos que hacen este tipo de transportes."
      },
      {
        "id": "d",
        "text": "El documento que acredita al conductor como profesional especializado. Referencia Legal: TIR, Convenio, Art. 17"
      }
    ],
    "correct": "a"
  },
  {
    "num": "15",
    "question": "En el supuesto de que un mismo camión transporte dos o más mercancías diferentes, ¿qué acción es correcta?",
    "options": [
      {
        "id": "a",
        "text": "No colocar las mercancías más pesadas sobre las ligeras."
      },
      {
        "id": "b",
        "text": "Dejar los huecos existentes entre mercancías de distintos embalajes."
      },
      {
        "id": "c",
        "text": "Cargar mercancías peligrosas junto a otras que no lo sean."
      },
      {
        "id": "d",
        "text": "Ninguna de las tres acciones anteriores es correcta."
      }
    ],
    "correct": "a"
  },
  {
    "num": "16",
    "question": "¿Para qué sirve la autorización de la CEMT?",
    "options": [
      {
        "id": "a",
        "text": "Habilita a realizar transporte internacional de mercancías liberalizado entre países miembros de la organización y a transitar por su territorio."
      },
      {
        "id": "b",
        "text": "Habilita a realizar transporte internacional de mercancías no liberalizado por todo el mundo."
      },
      {
        "id": "c",
        "text": "Habilita a realizar transporte internacional de mercancías no liberalizado entre países miembros de la organización y a transitar por su territorio."
      },
      {
        "id": "d",
        "text": "Habilita a realizar servicios de cabotaje."
      }
    ],
    "correct": "c"
  },
  {
    "num": "17",
    "question": "¿Cómo se llama el sistema de sujeción basado en el rozamiento entre el elemento de sujeción y la carga, por un lado, con las paredes y el suelo de la caja, por otro?",
    "options": [
      {
        "id": "a",
        "text": "Sistema de sujeción directa."
      },
      {
        "id": "b",
        "text": "Sistema de sujeción flexible."
      },
      {
        "id": "c",
        "text": "Sistema de sujeción por resistencia."
      },
      {
        "id": "d",
        "text": "Sistema de sujeción indirecta."
      }
    ],
    "correct": "d"
  },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "d",
        "text": "Este tiempo no se computa dentro de la jornada laboral de un conductor."
      }
    ],
    "correct": "d"
  },
